// 숏폼 작가 필명 2인 스프라이트 생성 — 임태윤·곽재현의 stand/sit_front/face 3종.
// 2026-09-03 작가 페르소나 3인 체제로 늘리면서 추가(유하린은 shortswriter 로 이미 있음).
// gen_shorts_sprites.mjs 와 동일 파이프라인·동일 STYLE 이라 기존 캐릭터들과 톤이 맞는다.
...
const CHARS = {
  shortswriter2: {
    who: 'A Korean man in his late 20s, a short-form video scriptwriter with a friendly conversational vibe, ' +
      'short neat black hair and round glasses, wearing a mustard knit sweater over a collared shirt, ' +
      'holding a small notebook and a pen, warm approachable smile',
  },
  shortswriter3: {
    who: 'A Korean man in his early 50s, a veteran garden writer with a calm grounded presence, ' +
      'short greying hair, wearing a khaki work vest over a plaid shirt and sturdy trousers, ' +
      'holding a pair of pruning shears and a weathered field notebook',
  },
};
