// 숏폼팀 스프라이트 생성 — 유하린(작가)·서준영(디렉터)의 stand/sit_front/face 3종.
...
const CHARS = {
  shortswriter: {
    who: 'A young Korean woman in her mid 20s, a short-form video scriptwriter with bright energetic vibes, ' +
      'long dark hair in a loose ponytail, wearing an oversized denim jacket over a white tee, ' +
      'holding a smartphone on a small handheld gimbal in one hand and a script card in the other',
  },
  shortsdirector: {
    who: 'A Korean man in his late 20s, a short-form video director with a focused creative look, ' +
      'wavy dark hair and a black cap worn backwards, wearing a charcoal hoodie with headphones around his neck, ' +
